...
const Footer = () => {
  return (
    <footer className="px-8 py-10 border-t border-c3 flex flex-col md:flex-row justify-between items-start md:items-center gap-12 bg-bg">
      {/* Brand Section */}
      <div className="max-w-[200px]">
        <p className="text-[10px] uppercase tracking-[0.4em] text-c2 mb-3">Connect</p>
        <h3 className="text-2xl font-bold uppercase tracking-tighter text-c1 leading-none">
          Contact <span className="font-light italic">Me</span>
        </h3>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-10 md:gap-20">
        ...
        <div className="flex flex-col">
          <span className="text-[10px] uppercase tracking-widest text-c2 mb-4">My Connections:</span>
          <div className="flex items-center gap-6">
            ...
            <a 
              ...
              className="text-c1 hover:opacity-60 transition-opacity"
              aria-label="LinkedIn"
            >
              <svg className="w-6 h-6 fill-current" viewBox="0 0 382 382">
            ...
            {/* GitHub */}
            <a 
              href="https://github.com/iasonLesg" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-c1 hover:opacity-60 transition-opacity"
              aria-label="GitHub"
            >
              <svg className="w-6 h-6 fill-current" viewBox="0 -0.5 25 25">
            ...
            {/* Gmail */}
            <a 
              href="mailto:Iasonlesgidis@gmail.com" 
              className="text-c1 hover:opacity-60 transition-opacity"
              aria-label="Gmail"
            >
              <svg className="w-6 h-6 fill-current" viewBox="0 -31.5 256 256">
                <g>
      ...
      {/* Copyright Info */}
      <div className="md:text-right border-t md:border-t-0 border-c3 pt-6 md:pt-0 w-full md:w-auto">
        <p className="text-[10px] uppercase tracking-widest text-c2">
          © 2026 Jason Lesgidis
        </p>
        <p className="text-[9px] uppercase tracking-widest text-c2 mt-1">
          Thessaloniki, Greece
        </p>
      </div>
    </footer>
